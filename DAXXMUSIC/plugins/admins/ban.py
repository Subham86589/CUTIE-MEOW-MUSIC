...
async def ban_user(user_id, first_name, admin_id, admin_name, chat_id, reason, time=None):
    try:
        ...
        msg_text = "Ban rights? You are not as powerful as Lord Subbu 🙌\nSo Give me ban rights! 😡🥺"
        return msg_text, False
    except UserAdminInvalid:
        msg_text = "I wont ban an admin bruh You are not As powerful as Lord SUBBU!!"
        return msg_text, False
...
async def mute_user(user_id, first_name, admin_id, admin_name, chat_id, reason, time=None):
    try:
        ...
        msg_text = "Mute rights? Nah, You are not as powerful as Lord Subbu 🙌\nGive me Mute rights! 😡🥺"
        return msg_text, False
    except UserAdminInvalid:
